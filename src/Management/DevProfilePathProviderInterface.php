...
{
    // One entry per path to profile: ['path' => string, 'label' => ?string]. The path is local and absolute ("/", "/pages/contact"), never a full url - it's handed straight to the kernel, no HTTP request and no host involved
