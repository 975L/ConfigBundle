...
class Config
{
    ...
    // Any character valid in a CSS <color> (hex, rgb()/rgba(), hsl()/hsla(), named colors like
    // "tomato"): also blocks ";", "{", "}", quotes... so a theme color can't break out of its
    // declaration in the site-theme.css file generated by SiteBundle's ThemeVariablesCssListener
