...
// whose attribute route loader recursively reflects every class under the bundle root - the two
// fixtures below are their own PSR-4 files (TaggedInterfacePassFixtureProvider/...Other) for the
// same reason: that loader can't reflect a class that's only defined as a side effect of this one
