...
class YourController extends Controller
{
    ...
    public function config(Request $request, ConfigServiceInterface $configService)
    {
         ...
         * As the configuration is now manageable directly from the web, you may have to add your_filename.yaml to your .gitignore (+ .bak as a backup is made when saving)
...
Then call the defined Route in a web browser and set-up your config data. Of course you can still access the file itself.
